 ...
 * @author Wei Peng
 */
public class GetIoBytesInfoService {
    ...
    public ArrayList[] getMergeInfo(InfoBean infoBean){
        ...
        for (int i = 0;i <array.length();i ++){
            ...
            if ("vda".equals(jsonObject3.getString("deviceName"))) {
                ...
                try {
                    list1.add(Float.valueOf(jsonObject3.getString("rkB")));
                } catch (Exception e) {
                    list1.add((float) 0);
                }
                try {
                    list2.add(Float.valueOf(jsonObject3.getString("wkB")));
                } catch (Exception e) {
                    list2.add((float) 0);
                }
            }
                ...
                try {
                    list3.add(Float.valueOf(jsonObject3.getString("rkB")));
                }catch (Exception e){
                    list3.add((float) 0);
                }
                try {
                    list4.add(Float.valueOf(jsonObject3.getString("wkB")));
                }catch (Exception e){
                    list4.add((float) 0);
                }
            }
