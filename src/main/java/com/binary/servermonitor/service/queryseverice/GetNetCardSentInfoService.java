 ...
 * @author Wei Peng
 */
public class GetNetCardSentInfoService {
    ...
    public ArrayList[] getNetCardSend(InfoBean infoBean){
        ...
        for (int i = 0;i < array.length();i ++){
            ...
            if ("eth0".equals(jsonObject3.getString("iface"))){
                try {
                ...
                try {
                    list1.add(Float.valueOf(jsonObject3.getString("txpck")));
                }catch (Exception e){
                    list1.add((float) 0);
                }
                try {
                    list2.add(Float.valueOf(jsonObject3.getString("txkB")));
                }catch (Exception e){
                    list2.add((float) 0);
                }
                try {
                    list3.add(Float.valueOf(jsonObject3.getString("txcmp")));
                }catch (Exception e){
                    list3.add((float) 0);
                }
                try {
                    list4.add(Float.valueOf(jsonObject3.getString("txmcst")));
                }catch (Exception e){
                    list4.add((float) 0);
                }
            }
