 ...
 * @author Wei Peng
 */
public class GetMysqlThreadCacheService {
    ...
    public ArrayList[] getMyqlThreadCache(InfoBean infoBean){
        ...
        for (int i = 0;i <array.length();i ++) {
            ...
            try {
                list1.add(Float.valueOf(df.format(Float.valueOf(jsonObject3.getString("Thread_cache_hits"))*100)));
            }catch (Exception e){
                list1.add((float) 0);
            }
        }
