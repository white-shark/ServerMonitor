 ...
 * @author Wei Peng
 */
public class GetMemUseInfoService {
    ...
    public ArrayList[] getMemUseService(InfoBean memUseInfoBean){
        ...
        for (int i = 0; i <array.length();i ++){
            ...
            try {
                ...
                float data = Float.valueOf(jsonObject3.getString("memTotal"))/1000;
            ...
            try {
                float data = Float.valueOf(jsonObject3.getString("memUsed"))/1000;
                DecimalFormat df = new DecimalFormat(".00");
            ...
            try {
                float data = Float.valueOf(jsonObject3.getString("memFree"))/1000;
                DecimalFormat df = new DecimalFormat(".00");
            ...
            try {
                float data = Float.valueOf(jsonObject3.getString("memCache"))/1000;
                DecimalFormat df = new DecimalFormat(".00");
