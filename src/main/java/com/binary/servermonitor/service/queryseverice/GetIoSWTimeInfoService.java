 ...
 * @author Wei Peng
 */
public class GetIoSWTimeInfoService {
    ...
    public ArrayList[] getIoSWTime(InfoBean infoBean){
        ...
        for (int i = 0;i <array.length();i ++){
            ...
            if ("vda".equals(jsonObject3.getString("deviceName"))) {
                ...
                try {
                    list1.add(Float.valueOf(jsonObject3.getString("await")));
                } catch (Exception e) {
                    list1.add((float) 0);
                }
                try {
                    list2.add(Float.valueOf(jsonObject3.getString("svctm")));
                } catch (Exception e) {
                    list2.add((float) 0);
                }
            }
                ...
                try {
                    list3.add(Float.valueOf(jsonObject3.getString("await")));
                }catch (Exception e){
                    list3.add((float) 0);
                }
                try {
                    list4.add(Float.valueOf(jsonObject3.getString("svctm")));
                }catch (Exception e){
                    list4.add((float) 0);
                }
            }
