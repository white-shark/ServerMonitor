 ...
 * @author Wei Peng
 */
public class GetNetCardRecvInfoService {
    ...
    public ArrayList[] getNetCardRecvInfo(InfoBean infoBean){
        ...
        for (int i = 0;i <array.length();i ++){
            ...
            if ("eth0".equals(jsonObject3.getString("iface"))){
                ...
                try {
                    list1.add(Float.valueOf(jsonObject3.getString("rxpck")));
                }catch (Exception e){
                    list1.add((float) 0);
                }
                try {
                    list2.add(Float.valueOf(jsonObject3.getString("rxkB")));
                }catch (Exception e){
                    list2.add((float) 0);
                }
                try {
                    list3.add(Float.valueOf(jsonObject3.getString("rxcmp")));
                }catch (Exception e){
                    list3.add((float) 0);
                }
            }
