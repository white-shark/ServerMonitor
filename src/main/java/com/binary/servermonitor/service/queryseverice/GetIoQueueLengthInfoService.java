 ...
 * @author Wei Peng
 */
public class GetIoQueueLengthInfoService {
    ...
    public ArrayList[] getIoQueueLength(InfoBean infoBean){
        ...
        for (int i = 0;i <array.length();i ++){
            ...
            if ("vda".equals(jsonObject3.getString("deviceName"))) {
                ...
                try {
                    list1.add(Float.valueOf(jsonObject3.getString("avgqusz")));
                } catch (Exception e) {
                    list1.add((float) 0);
                }
            }
                ...
                try {
                    list2.add(Float.valueOf(jsonObject3.getString("avgqusz")));
                }catch (Exception e){
                    list2.add((float) 0);
                }
            }
