 ...
 * @author Wei Peng
 */
public class GetMysqlQueryCacheService {
    ...
    public ArrayList[] getMyqlQueryCache(InfoBean infoBean){
        ...
        for (int i = 0;i <array.length();i ++) {
            ...
            try {
                list1.add(Float.valueOf(jsonObject3.getString("Query_cache_hits"))*100);
            }catch (Exception e){
                list1.add((float) 0);
            }
        }
