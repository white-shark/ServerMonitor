...
import com.binary.servermonitor.data_api.host.Instance;
import com.binary.servermonitor.data_api.host.Interface;
import com.binary.servermonitor.data_api.host.Internet;
import com.binary.servermonitor.data_api.host.Volume;
...
public class ImageCreatApi {
   ...
   private String HAMCSha256(String url,String AccessKeySecret){
    ...
    public String url(Requestparameters requestparameters,String hostId,String volumeType,String name,String description){
