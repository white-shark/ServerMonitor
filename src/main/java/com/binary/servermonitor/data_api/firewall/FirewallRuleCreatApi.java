package com.binary.servermonitor.data_api.firewall;
 ...
 * @author Wei Peng
 */
public class FirewallRuleCreatApi {
   ...
   private String HAMCSha256(String url,String AccessKeySecret){
    ...
    public String url(Requestparameters requestparameters,String firewallId,String name,String direction,String portStart,String portEnd,
