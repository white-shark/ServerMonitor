 ...
 * @author Wei Peng
 */
public class PrivateNetworkChangeApi {
   ...
   private String HAMCSha256(String url,String AccessKeySecret){
    ...
    public String url(Requestparameters requestparameters,String hostId,String oldNetworkId,String newNetworkId,String networkIpAddress){
