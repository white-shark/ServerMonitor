...
/**
 * 传入参数Requestparameters对象和布尔类型Force，若Force为true则强制重启，若Force为false则不强制重启
 * @author Wei Peng
 * @retrn 返回主机是否修改成功 {"i-si6rj33hdi40d":"云主机：i-si6rj33hdi40d重启成功"}
 */
public class RebootApi {
    ...
    public String url(Requestparameters requestparameters, Boolean Force){
    ...
    private String json(String json,String id) {
        ...
        try {
            ...
            if ("RebootInstance".equals(Action)){
                System.out.println("云主机：" + id + "重启成功");
                JSONObject jsonObject1 = new JSONObject();
                jsonObject1.put(id,"云主机：" + id + "重启成功");
