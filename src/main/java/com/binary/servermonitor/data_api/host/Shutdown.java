...
/**
 * @author Wei Peng
 * @retrn 返回开机是否成功或报错信息 {"i-si6rj33hdi40d":"云主机：i-si6rj33hdi40d开机成功"}
 */
public class Shutdown {
    ...
    private String json(String json,String id) {
        ...
        try {
            ...
            if (1100 == ErrorCode){
                System.out.println("云主机：" + id + " 未在运行");
                JSONObject jsonObject1 = new JSONObject();
                jsonObject1.put(id,"云主机：" + id + " 未在运行");
            ...
            try {
                ...
                Action = jsonObject.getString("Action");
                TotalCount = jsonObject.getInt("TotalCount");
                System.out.println("云主机：" + id + "关机成功");
                JSONObject jsonObject1 = new JSONObject();
                jsonObject1.put(id,"云主机：" + id + "关机成功");
                rejson = jsonObject1.toString();
