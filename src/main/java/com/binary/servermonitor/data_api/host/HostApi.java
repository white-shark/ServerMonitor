...
//        String action;
//        Integer totalCount;
//        Instance[] InstanceSet = new Instance[0];
...
//            }
//            else {
//                InstanceSet = new Instance[totalCount];
//                JSONArray array = jsonObject.getJSONArray("InstanceSet");
//                for (int i = 0; i < totalCount; i++) {
//                    Instance instance = new Instance();
//                    JSONObject jsonObject1 = array.getJSONObject(i);
//                    instance.setId(jsonObject1.getString("Id"));
//                    instance.setName(jsonObject1.getString("Name"));
//                    instance.setStatus(jsonObject1.getString("Status"));
//                    instance.setTask(jsonObject1.getString("Task"));
//                    instance.setShutdownTime(String.valueOf(jsonObject1.get("ShutdownTime")));
//                    instance.setBindStatus(jsonObject1.getString("BindStatus"));
//                    instance.setKeyPairName(String.valueOf(jsonObject1.get("KeyPairName")));
//                    instance.setHost(jsonObject1.getString("Host"));
//                    instance.setImageName(jsonObject1.getString("ImageName"));
//                    instance.setProductStatus(jsonObject1.getString("ProductStatus"));
//                    instance.setPayType(jsonObject1.getString("PayType"));
//                    instance.setProductModelId(jsonObject1.getString("ProductModelId"));
//                    instance.setProductType(jsonObject1.getString("ProductType"));
//                    instance.setCpu(jsonObject1.getInt("Cpu"));
//                    instance.setMemory(jsonObject1.getInt("Memory"));
//                    instance.setPassword(jsonObject1.getString("Password"));
//                    instance.setKeyPair(String.valueOf(jsonObject1.get("KeyPair")));
//                    instance.setCreateTime(jsonObject1.getString("CreateTime"));
//                    instance.setDueTime(jsonObject1.getString("DueTime"));
//                    instance.setCloseTime(jsonObject1.getString("CloseTime"));
//                    JSONArray array1 = jsonObject1.getJSONArray("InterfaceSet");
//                    instance.setInterfaceSize(array1.length());
//                    Interface[] interfaces = new Interface[array1.length()];
//                    for (int j = 0; j < array1.length(); j++) {
//                        JSONObject jsonObject2 = array1.getJSONObject(j);
//                        Interface anInterface = new Interface();
//                        anInterface.setId(jsonObject2.getString("Id"));
//                        anInterface.setNetworkName(jsonObject2.getString("NetworkName"));
//                        anInterface.setBandwidth(jsonObject2.getInt("Bandwidth"));
//                        anInterface.setInstanceId(jsonObject2.getString("InstanceId"));
//                        anInterface.setNetworkId(jsonObject2.getString("NetworkId"));
//                        anInterface.setSubnetId(jsonObject2.getString("SubnetId"));
//                        anInterface.setMacAddress(jsonObject2.getString("MacAddress"));
//                        anInterface.setIpAddress(jsonObject2.getString("IpAddress"));
//                        anInterface.setStatus(jsonObject2.getString("Status"));
//                        anInterface.setUuid(jsonObject2.getString("Uuid"));
//                        anInterface.setType(jsonObject2.getString("Type"));
//                        interfaces[j] = anInterface;
//                    }
//                    instance.setInterfaceSet(interfaces);
//                    JSONArray array2 = jsonObject1.getJSONArray("Internet");
//                    instance.setInternetSize(array2.length());
//                    Internet[] internets = new Internet[array2.length()];
//                    for (int j = 0; j < array2.length(); j++) {
//                        Internet internet = new Internet();
//                        JSONObject jsonObject2 = array2.getJSONObject(j);
//                        internet.setId(jsonObject2.getString("Id"));
//                        internet.setIpAddress(jsonObject2.getString("IpAddress"));
//                        internet.setBandwidth(jsonObject2.getInt("Bandwidth"));
//                        internet.setPayType(jsonObject2.getString("PayType"));
//                        internet.setDueTime(jsonObject2.getString("DueTime"));
//                        internet.setCloseTime(jsonObject2.getString("CloseTime"));
//                        internet.setAllocateTime(jsonObject2.getString("AllocateTime"));
//                        internet.setProductStatus(jsonObject2.getString("ProductStatus"));
//                        internet.setProductModelId(jsonObject2.getString("ProductModelId"));
//                        internet.setProductType(jsonObject2.getString("ProductType"));
//                        internets[j] = internet;
//
//                    }
//                    instance.setInternetSet(internets);
//                    JSONArray array3 = jsonObject1.getJSONArray("VolumeSet");
//                    instance.setVolumeSize(array3.length());
//                    Volume[] volumes = new Volume[array3.length()];
//                    for (int j = 0; j < array3.length(); j++) {
//                        Volume volume = new Volume();
//                        JSONObject jsonObject2 = array3.getJSONObject(j);
//                        volume.setId(jsonObject2.getString("Id"));
//                        volume.setName(jsonObject2.getString("Name"));
//                        volume.setType(jsonObject2.getString("Type"));
//                        volume.setProductModelId(jsonObject2.getInt("ProductModelId"));
//                        volume.setPayType(jsonObject2.getString("PayType"));
//                        volume.setSize(jsonObject2.getInt("Size"));
//                        volume.setIndex(jsonObject2.getInt("Index"));
//                        volume.setDueTime(jsonObject2.getString("DueTime"));
//                        volume.setCloseTime(String.valueOf(jsonObject2.get("CloseTime")));
//                        volume.setCreateTime(jsonObject2.getString("CreateTime"));
//                        volume.setUuid(jsonObject2.getString("Uuid"));
//                        volume.setProductStatus(jsonObject2.getString("ProductStatus"));
//                        volumes[j] = volume;
//                    }
//                    instance.setVolumeSet(volumes);
//                    instance.setUuid(jsonObject1.getString("Uuid"));
//                    instance.setFirewallId(jsonObject1.getString("FirewallId"));
//                    instance.setImageId(jsonObject1.getString("ImageId"));
//                    instance.setOsName(jsonObject1.getString("OsName"));
//                    instance.setOsVersion(jsonObject1.getString("OsVersion"));
//                    instance.setOsBit(jsonObject1.getString("OsBit"));
//                    instance.setInitPassword(jsonObject1.getString("InitPassword"));
//                    instance.setUserId(jsonObject1.getString("UserId"));
//                    instance.setLocked(jsonObject1.getBoolean("Locked"));
//                    instance.setIdLong(jsonObject1.getString("IdLong"));
//                    instance.setHostName(jsonObject1.getString("HostName"));
//                    instance.setInstanceSeries(jsonObject1.getString("InstanceSeries"));
//                    instance.setSeriesName(jsonObject1.getString("SeriesName"));
//                    InstanceSet[i] = instance;
//                }
//            }
//
//
...
//            JSONObject jsonObject111 = new JSONObject(json);
//            String errormessage = jsonObject111.getString("ErrorMessage");
//            return errormessage;
//        } catch (Exception e){
//            String Code;
//            String ErrorMessage;
...
//            ErrorMessage = jsonObjectErr.getString("ErrorMsg");
...
//        Gson gson = new Gson();
//        rejson.append(gson.toJson(InstanceSet));
//        rejson.append(gson.toJson(totalCount));
//        return String.valueOf(rejson);
//    }
}
