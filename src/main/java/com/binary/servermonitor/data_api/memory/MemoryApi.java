package com.binary.servermonitor.data_api.memory;
...
/**
 * @author Wei Peng
 * @retrn 实例{"Data":[["2019-04-24T04:03:00Z","12.82"]],"Id":"i-si6rj33hdi40d","Unit":"%","Interval":60}
 * Data中的数据由二维数组组成
 * Id为主机Id
 * Unit为单位
 * Interval 时间间隔
...
public class MemoryApi {
    ...
    public String url(Requestparameters requestparameters){
        ...
        try{
            ...
            Jsondate = "error";
            logger.error("MemoryApi Request error" + e.getMessage());
        }finally {
            response.close();
        }
