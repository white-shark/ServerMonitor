...
import com.binary.servermonitor.jvm.RuntimeInfoSeverice;
...
public class RuntimeInfoController {
    @Autowired
    RuntimeInfoSeverice runtimeInfoSeverice;

    @GetMapping("/getRuntimeInfo")
    public String getRuntimeInfo(){
        String res = runtimeInfoSeverice.getRuntimeInfo("49.82.41.170:1024",
